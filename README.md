...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/docs/bluer-README), based on 📐 [`bluer_academy-5.184.1`](https://github.com/kamangir/bluer-academy).
